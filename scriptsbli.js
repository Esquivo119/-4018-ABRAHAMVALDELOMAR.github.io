...
function deleteBook(index) {
    books.splice(index, 1); // Eliminar el libro del array
    localStorage.setItem('books', JSON.stringify(books)); // Actualizar el localStorage
    displayBooks(); // Volver a mostrar la lista de libros
}
